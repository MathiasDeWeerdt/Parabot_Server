...
public class Config {
	...
	public static final int CONNECTION_DELAY = 100; // how long one ip can keep
													// connecting
	public static final int IPS_ALLOWED = 25; // how many ips are allowed
	...
	public static final int START_LOCATION_X = 3087; // start
														// here
	...
	public static final int MELEE_EXP_RATE_HARD = 100;
	public static final int RANGE_EXP_RATE_HARD = 100;
	public static final int MAGIC_EXP_RATE_HARD = 100;
	 ...
	 */
	public static final int PRAYER_EXPERIENCEINHOUSE = 10;
