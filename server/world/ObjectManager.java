...
public class ObjectManager {
	...
	public void loadCustomSpawns(Client c) {
		...
		c.getPA().checkObjectSpawn(27568, 3207, 3421, 2, 10); // Chaos Tunnle
																// entrance
		c.getPA().checkObjectSpawn(11402, 3211, 3435, 2, 10); // bank
		c.getPA().checkObjectSpawn(11402, 3212, 3435, 2, 10); // bank
		c.getPA().checkObjectSpawn(11402, 3213, 3435, 2, 10); // bank
		c.getPA().checkObjectSpawn(11402, 3214, 3435, 2, 10); // bank
		c.getPA().checkObjectSpawn(24161, 3216, 3433, 2, 10); // fountain
		c.getPA().checkObjectSpawn(24161, 3208, 3433, 2, 10); // fountain
		c.getPA().checkObjectSpawn(-1, 3207, 3435, 2, 10); // remove stall
		c.getPA().checkObjectSpawn(-1, 3221, 3431, 2, 10); // remove stall
		c.getPA().checkObjectSpawn(-1, 3221, 3432, 2, 10); // remove stall
		c.getPA().checkObjectSpawn(-1, 3219, 3485, 2, 10); // remove stall
		...
		// HOMEBANK 2
		c.getPA().checkObjectSpawn(411, 3205, 3436, 1, 10); // Curse Prayers
		...
		c.getPA().checkObjectSpawn(409, 3205, 3433, 1, 10); // Normal praying //
															// altar
		...
		c.getPA().checkObjectSpawn(1032, 2602, 3153, 1, 10); // warning sign
																// FunPk
		c.getPA().checkObjectSpawn(1032, 2536, 4778, 0, 10); // warning sign
																// donor
		c.getPA().checkObjectSpawn(1032, 2537, 4777, 1, 10); // warning sign
																// donor
		c.getPA().checkObjectSpawn(1032, 2536, 4776, 2, 10); // warning sign
																// donor
