...
public class LoginHandler {
	public static void handleAllLoginCRAP(Client c) {
		 ...
		 */
		c.sendMessage("<shad=16105973>[Parabot]</shad> <shad=12606464>Welome to Parabot, please type ::vote and ::donate to support us!</shad>");
		/*
		 * c.sendMessage(
		 * "<shad=2320482>[Parabot]</shad> <shad=258024802>Type ::donate & ::vote daily for great rewards!</shad>"
		 * ); if(c.hasRecov == 0) { c.sendMessage(
		 * "<shad=2320482>[Parabot]</shad> <shad=258024802>To be able to recover your account, type ::setemail MAIL!!!</shad>"
		 * ); } else { c.sendMessage(
		 * "<shad=2320482>[Parabot]</shad> <shad=258024802>Your email is: "
		 * +c.email+""); c.sendMessage(
		 * "<shad=2320482>[Parabot]</shad> <shad=258024802>If the email you've set is invalid, ask for a change on ::forums!"
		 * ); }
		 */
	...
	public static void handleStaffTabLogin(Client c) {
		for (Player p : PlayerHandler.players) {
			if (p != null) {
				Client c2 = (Client) p;
				String staffNames[] = { "Parabot", "Parabot", /* ADMINSTART */
				"Parabot", "Parabot", "Parabot"/* MODSTART */, "Parabot",
						"Parabot", "Parabot", "Parabot" };
