...
public class GabbesAchievements {
	...
	private final static String NAME = "Parabot Diary Achievements";
	...
	public static void checkReqs(final Client c) {
		...
		if (!hasAll99s(c)) {
			c.sendMessage("You need to be atleast level 99 in every skill.");
			return;
		}
	...
	public static void writeAchievementTab(final Client c) {
		...
		c.getPA().sendFrame126("<col=ffb000>Task points: " + c.TPoints + "",
				33170);
		// c.getPA().sendFrame126("<col=ff00ff>Parabot Achievements", 33163);
