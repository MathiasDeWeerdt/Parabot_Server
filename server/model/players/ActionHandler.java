...
public class ActionHandler {
	...
	public void firstClickNpc(int npcType) {
		...
		case 919:
			...
			break;
		/*
		 * case 1008: c.getShops().openShop(82); c.getItems().deleteItem(12093,
		 * 1); c.getItems().deleteItem(12087, 1); c.getItems().deleteItem(12031,
		 * 1); c.getItems().deleteItem(12007, 1); break; case 9716:
		 * c.getShops().openShop(81); c.getItems().deleteItem(12093, 1);
		 * c.getItems().deleteItem(12087, 1); c.getItems().deleteItem(12031, 1);
		 * c.getItems().deleteItem(12007, 1); break; case 9715:
		 * c.getShops().openShop(80); c.getItems().deleteItem(12093, 1);
		 * c.getItems().deleteItem(12087, 1); c.getItems().deleteItem(12031, 1);
		 * c.getItems().deleteItem(12007, 1); break; case 1202:
		 * c.getShops().openShop(79); c.getItems().deleteItem(12093, 1);
		 * c.getItems().deleteItem(12087, 1); c.getItems().deleteItem(12031, 1);
		 * c.getItems().deleteItem(12007, 1); break; case 560:
		 * c.getShops().openShop(78); c.getItems().deleteItem(12093, 1);
		 * c.getItems().deleteItem(12087, 1); c.getItems().deleteItem(12031, 1);
		 * c.getItems().deleteItem(12007, 1); break;
		 */
		case 3381:
	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		case 3192:
			...
			c.getPA().sendFrame126("Parabot Highscores: Kills", 12102);
			break;
		case 50056:
	...
	public void secondClickNpc(int npcType) {
		...
		case 8591:
			c.sendMessage("Kill me for rewards you dumb ****");
			break;
