	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 636:
			c.getDH().sendNpcChat2("This is the Duel Arena!",
					"Warriors across Parabot duel eachother here!",
					c.talkingNpc, "Server Guide");
			c.nextChat = 640;
			break;
		case 637:
		...
		case 644:
			...
			break;
		case 645:
			c.getDH().sendNpcChat3("This is Nex", "Parabot's hardest boss!",
		...
		case 4445:
			...
			break;
		case 400:
			c.getDH().sendNpcChat2("Hello, welcome to the official Parabot",
		...
		case 1552:
			sendNpcChat3("Ho, ho ho!", "Christmas is around the corner!",
					"Here take this snow globe!", c.talkingNpc, "Santa");
			c.nextChat = 0;
			// c.santaPrize = 1;
			break;
