...
public class PlayerAssistant {
	...
	public void addStarterItems() {
		if (!c.addedItems) {
			...
			c.sendMessage("Welcome to Parabot if you need help ask the lovely community.");
	...
	public void destroySearch() {
		...
		sendFrame126("The bank of Parabot.", 5383);
	}
	 ...
	 * o.sendMessage("You recieved a Parabot Points! Killstreak: "
	...
	public void searchBank(String str) {
		...
		if (p > 0) {
			sendFrame126("Bank of Parabot - (search: '" + str + "')", 5383);
	...
	public void writeQuestTab() {
		getPlayerRank();
		calculateTask();
		c.getPA().sendFrame126("Parabot.org", 39164); // quest title
