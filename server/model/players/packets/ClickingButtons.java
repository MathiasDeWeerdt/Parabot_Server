...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Client c, int packetType, int packetSize) {
		...
		case 47085:
			...
			c.getPA().sendFrame126("Parabot Highscores: Top Kills", 12102);
			break;
		case 47084:
			c.getPA().resetFrames();
			c.getPA().getHighscores("PLP");
			c.getPA().sendFrame126("Parabot Highscores: Parabot Points",
					12102);
			break;
		case 47088:
			c.getPA().resetFrames();
			c.getPA().getHighscores("deaths");
			c.getPA().sendFrame126("Parabot Highscores: Top Deaths", 12102);
			break;
		case 47089:
			c.getPA().resetFrames();
			c.getPA().getHighscores("LP");
			c.getPA().sendFrame126("    Parabot Highscores: Loyalty Points",
					12102);
			break;
		...
		case 9192:
			...
			break;
		case 152252:
			c.getPA().sendFrame126("www.Parabot.Net", 12000);
			break;
		case 15062:
			c.getPA().closeAllWindows();
			break;
		...
		case 9157:// barrows tele to tunnels
			...
			if (c.dialogueAction == 13813) {
				...
				c.sendMessage("Grand Exchange will be added into Parabot V4 Client instead.");
				return;
			}
		...
		case 9158:
			...
			if (c.teleAction == 22) { // Firemaking Fm tele
				...
				c.sendMessage("You can firemake all over Parabot!");
			}
			if (c.dialogueAction == 510) {
		...
		case 50056:
			...
			c.SaveGame();
			c.getPA().startTeleport(3087, 3501, 0, type); // varrock
			// c.getPA().sendshh();
		...
		case 4146:
			...
			c.getDH()
					.sendOption5("War Zone (MASSIVE PLAYER V NPC WAR)",
							"Forgotten Warrior", "Mad Mummy", "BarrelsChest",
							"GodWars");
			c.teleAction = 6;
			break;
