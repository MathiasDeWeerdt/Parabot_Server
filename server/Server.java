...
public class Server {
	 ...
	 * System.out.println("[Parabot.Net] Launching Parabot #1 RSPS..");
	 ...
	 * (Exception ex) {
	 * System.out.println("[Parabot.Net] Error starting the server...");
	...
	public static void main(java.lang.String args[])
		...
		System.out.println("[Parabot.org] Launched Parabot #1 RSPS!");
		/**
		 * Main server tick.
		 */
